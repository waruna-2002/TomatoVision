...
def detect_tomatoes_industrial(img_bgr):
    ...
    # -------------------------------------------------------------------------
    # True tomato red/orange carotenoid pigments (Unique to Tomatoes)
    red_orange_seeds = (
        ((h_chan <= 13) | (h_chan >= 162)) & (s_chan > 75) & (v_chan > 50) |
        ((h_chan > 13) & (h_chan <= 26)) & (s_chan > 85) & (v_chan > 55)
    ).astype(np.uint8) * 255
    ...
    # =========================================================================
        ...
        # (Ignore tiny noise particles < 1.2% of image area)
        for c in contours:
            c_area = cv2.contourArea(c)
        ...
        # Cap single fruit mode to at most 4 fruits (a single/double test scene never has 200 fruits!)
        if len(detections) > 4:
...
images = {
    "1. Single Green Tomato Photo": cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787103060894.png")[58:518, 412:612],
    "2. Market Stall 1 (Potatoes & Sand)": cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787103912092.png")[58:518, 412:612],
    "3. Market Stall 2 (Radishes & Chilies)": cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787103863573.png")[58:518, 412:612],
