...
def detect_tomatoes_ultimate(img_bgr):
    ...
    # -------------------------------------------------------------------------
    if red_seed_count > (0.015 * img_area) or red_seed_count > 1200:
    ...
    # -------------------------------------------------------------------------
        ...
        mask_tomato = (
            ...
            ((h_chan > 38) & (h_chan <= 65)) & (s_chan > 45) & (v_chan > 40)
        ).astype(np.uint8) * 255
...
images = {
    "1. Single Green Tomato": (cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787102292862.png")[86:528, 412:612]),
    "2. Crate": (cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787102274874.png")[86:528, 412:612]),
    "3. Market 1 (Potatoes & Sand)": (cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787102229214.png")[86:528, 412:612]),
    "4. Market 2 (Radishes & Chilies)": (cv2.imread(r"C:\Users\Waruna\.gemini\antigravity\brain\d72fea25-187d-4266-99c6-341a7dceced8\.user_uploaded\media_1787102250844.png")[86:528, 412:612]),
}

for name, img in images.items():
    res = detect_tomatoes_ultimate(img)
    counts = {}
    for r in res:
        c = r["class_name"]
